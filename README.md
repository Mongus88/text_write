...
* abc betűkészlet külső fájból történő beolvasás, különbőző stílusok miatt
* nem létező karakter kezelése
* hattérnél 1 > karakter számnál ne csússzón szét a felirat
...
Az előző program nem a saját betűjével írta a betűket, ez javítva.
